        ...
        <div className='flex z-50 justify-between border-b border-black bg-primary text-white fixed w-full p-1'>
            <div className='flex'>
                ...
                {user ? (
                    ...
                    <div className='pt-1.5  gap-6 mt-2 ml-2 font-bold text-xxl'>BETZHUB</div>
                )}
            </div>
                    ...
                    {navList?.map((item, index) => (
                        <Link
                            ...
                            className={`${location.pathname === item?.href && 'bg-gray-50 text-gray-800'
                                } hover:bg-gray-50 hover:text-gray-800 transition duration-300 px-3 py-1  mx-6 text-xl rounded`}
                        >
                            {item?.name}
                        </Link>
                    ))}
            ...
            <div className='flex space-x-1 md:space-x-2 p-1.5 text-xs' style={{ fontSize: '12px' }}>
                {user ? (
                    <>
